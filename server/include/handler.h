 ...
 * * @param client_socket The socket of the joining player.
 ...
 * * @param client_socket The socket of the leaving player.
 ...
 * @param client_socket The socket of the player making the move.
 ...
 * * @param client_socket The new socket descriptor.
